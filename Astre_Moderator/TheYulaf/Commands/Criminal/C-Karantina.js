...
module.exports.execute = async (client, message, args) => {
    ...
    if(!reason) return message.reply("Geçerli \`Karantina\` sebebi belirtmelisin.");
    ...
    message.channel.send(`${victim}, ${message.author} tarafından **${reason}** sebebiyle geçici olarak cezalandırıldı, Ceza Numarası - (\`#${document.Id}\`) ${Settings.emojiler.tik}`)
