...
module.exports.execute = async (client, message, args) => {
    if (!message.member.hasPermission("ADMINISTRATOR") && !Settings.Perm.Commander.some(role => message.member.roles.cache.has(role))) return message.reply("bunu yapmak için yetkin yok.");
    ...
    message.channel.send(`${victim}, ${message.author} tarafından **kayıtsız** rolüne atıldı.`);
}
